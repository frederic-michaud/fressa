...
test_that("We can correctly evalutate if convergence is reach",
          {
            ...
            #freqs,generation,min.generations,max.generations,criteria
            expect_true(is.converged(freq1, 3, 1,10000, 1))
            expect_false(is.converged(freq1, 3, 1,10000, 0.1))
            expect_false(is.converged(freq1, 2, 3,10000, 1))
            expect_true(is.converged(freq2, 3, 1,10000, 1))
            expect_false(is.converged(freq2, 3, 1,10000, 0.1))
            expect_false(is.converged(freq2, 2, 3,10000, 1))
            expect_false(is.converged(freq3, 3,1,10000, 1))
            expect_warning(is.converged(freq2, 3,1,2, 0.01))
          }
)
