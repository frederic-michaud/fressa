...
```{r}
plot.haplotype.frequency(genome,freqs,name=matrix(c("x","y","f","m"),nrow=2,byrow = T))
plot.genotype.frequency(genome,freqs,name=matrix(c("x","y","f","m"),nrow=2,byrow = T))
...
```{r}
genome1
get.genotype.with.given.allele(genome1,1,1)
```
